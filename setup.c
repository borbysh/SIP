...
#define NSTEPS 2001  // Default number of iteration steps

/* Initialize the heat equation solver */
void initialize(int argc, char *argv[], field *current, int *nsteps)
{
    /*
...
void finalize(field *temperature)
{
    free_2d(temperature->data);
}
